...
public class NewContainerAdapter extends ArrayAdapter<GasContainer> {
    ...
    public NewContainerAdapter(Context context, int textViewResourceId, ArrayList<GasContainer> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        v = inflater.inflate(R.layout.new_container_list_item, null);
